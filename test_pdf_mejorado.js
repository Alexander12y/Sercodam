...
async function testPDFMejorado() {
  console.log('🧪 Probando PDF mejorado...');
  ...
  try {
    ...
    // Detalle con id_item para probar ficha técnica
    const detalle = [
      {
        id_detalle: 20,
        id_cotizacion: 17,
        id_item: 846, // ID del paño
        cantidad: '1.00',
    ...
    // Guardar el PDF
    const outputPath = path.join(__dirname, 'test_pdf_mejorado.pdf');
